...
public class Kaifeng {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Kaifeng.class);

    private boolean start = false;

    private String token = "";

    private String username = "kaifeng";

    private Set<Integer> deviceSet = new HashSet<>();

    private String address = "http://221.176.156.141:8686/kfsanitate/services/SaveYCJCService?wsdl";
