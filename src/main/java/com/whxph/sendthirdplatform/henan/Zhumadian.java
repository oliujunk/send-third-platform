...
public class Zhumadian {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Zhumadian.class);

    private boolean start = false;

    private String token = "";

    private String username = "zhumadian";

    private Set<Integer> deviceSet = new HashSet<>();

    private String address = "http://112.53.105.18:7001/sanitate/services/SaveYCJCService?wsdl";
