 ...
 */
@Component
public class Nanyang2019 {

    private static final Logger LOGGER = LoggerFactory.getLogger(Nanyang2019.class);

    private boolean start = false;

    private String token = "";

    private String username = "nanyang2019";

    private Set<Integer> deviceSet = new HashSet<>();

    private String address = "http://111.6.77.46:7013/nysanitate/services/SaveYCJCService?wsdl";
            ...
            for (Integer deviceId : deviceSet) {
                ...
                try {
                    ...
                    String content = "DevID:|:" + facId +
                            ...
                            "#|#PRE:|:" + decimalFormat.format(entity.getJSONObject(9).getFloatValue("eValue")) +
