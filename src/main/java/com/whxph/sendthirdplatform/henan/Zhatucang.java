 ...
 */
@Component
public class Zhatucang {

    private static final Logger LOGGER = LoggerFactory.getLogger(Zhatucang.class);

    private boolean start = false;

    private String token = "";

    private String username = "zhatucang";

    private Set<Integer> deviceSet = new HashSet<>();

    private String address = "http://42.236.61.105:8686/xncjk/services/SaveYCJCService?wsdl";
