 ...
 */
@Component
public class Jinancj {

    private static final Logger LOGGER = LoggerFactory.getLogger(Jinancj.class);
    ...
    private String username = "jinancj";
    ...
    private void updateChannel() throws InterruptedException {
        ...
        client.handler(new ChannelInitializer<NioSocketChannel>() {
            ...
            protected void initChannel(NioSocketChannel ch) {
                ch.pipeline().addLast(new CJReceiveHandler());
            }
        });
        ...
        for (Integer deviceId : deviceSet) {
            ChannelFuture channelFuture = client.connect("124.128.208.34", 60101).sync();
